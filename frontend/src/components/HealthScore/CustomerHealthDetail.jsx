...
const CustomerHealthDetail: React.FC<CustomerHealthDetailProps> = ({ customerId }) => {
    ...
    return (
      <div className="bg-red-50 border border-red-200 rounded-lg p-6">
        <div className="flex justify-between items-center">
          <div>
            <h3 className="text-lg font-semibold text-red-800">Error Loading Health Score</h3>
  ...
  if (!healthScore) {
    return (
      <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
        <p className="text-gray-600">No health score data available for this customer.</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex justify-between items-start mb-6">
          ...
          <div className="text-right">
            ...
            <div
              ...
              style={{
                backgroundColor: getHealthScoreColor(healthScore.overall_score) + '20',
        ...
        <div className="flex justify-between items-center">
          <div className="text-sm text-gray-600">
            Customer Segment: <span className="font-medium">{healthScore.data_summary.customer_segment}</span>
          </div>
      ...
      {/* Health Factors */}
      <div>
        <h3 className="text-xl font-semibold text-gray-900 mb-4">Health Factors</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
